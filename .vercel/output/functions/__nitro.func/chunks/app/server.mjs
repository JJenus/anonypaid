import { hasInjectionContext, inject, version, unref, defineComponent, h, computed, ref, provide, shallowReactive, watch, Suspense, nextTick, Transition, toRef, isRef, useSSRContext, mergeProps, createApp, effectScope, reactive, getCurrentInstance, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, isReadonly, isShallow, isReactive, toRaw, withCtx } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_nuxt/index-pLY6s7BY.mjs').then((m) => m.default || m)
  },
  {
    name: "redeem",
    path: "/redeem",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_nuxt/redeem-gtg31tqy.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/verify-email-l69jgB_N.mjs').then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  "admin-auth": () => import('./_nuxt/adminAuth--okndDzq.mjs'),
  auth: () => import('./_nuxt/auth-DOxrdkZh.mjs')
};
...
const layouts = {
  auth: () => import('./_nuxt/auth-HiczrcLY.mjs').then((m) => m.default || m),
  default: () => import('./_nuxt/default-OyuU6zJe.mjs').then((m) => m.default || m)
};
...
const useAppSettings = () => {
  ...
  const getFractionalCurrency = (amount) => {
    const value = currency(amount);
    return value.intValue;
  };
  const formatFractionalCurrency = (amount, sym = "NGN ") => {
  ...
  const load = () => {
    const axiosConfig = {
      method: "get",
      url: `${(/* @__PURE__ */ useRuntimeConfig()).public.BE_API}/settings`,
      timeout: 2e4
      // headers: {
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ id: "block-ui" }, _attrs))}>`);
      _push(ssrRenderComponent(_component_NuxtLayout, {
        class: unref(loading) ? "d-none" : ""
      }, {
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-iKlYpceP.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { useAppSettings as a, useRoute as b, createError as c, defineNuxtRouteMiddleware as d, entry$1 as default, useRouter as e, nuxtLinkDefaults as f, useState as g, useNuxtApp as h, injectHead as i, navigateTo as n, resolveUnrefHeadInput as r, useRuntimeConfig as u };
